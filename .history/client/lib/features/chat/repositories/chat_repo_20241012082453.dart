...
// You're reconstructing a new http.Response because the original response is in a stream, and once you've processed (read) the stream, you can't reuse the original response object as is. Therefore, you're essentially repackaging the body (jsonData) and combining it with the status code and headers from the original response to create a new, easily usable http.Response object for downstream use in your app.